...
export const gradingform_rubric_tools: ToolSpec[] = [
  {
    ...
    description: "Moodle web service function `gradingform_rubric_grader_gradingpanel_fetch`.",
    inputSchema: {
      type: "object",
      properties: {},
  ...
  },
  {
    ...
    description: "Moodle web service function `gradingform_rubric_grader_gradingpanel_store`.",
    inputSchema: {
      type: "object",
      properties: {},
      additionalProperties: true,
